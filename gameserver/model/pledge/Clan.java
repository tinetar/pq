...
public class Clan
{
	...
	public SubPledge createSubPledge(Player player, int pledgeType, int leaderId, String subPledgeName)
	{
		...
		if (pledgeType != -1 && ((_reputationScore < 0 && pledgeType < Clan.SUBUNIT_KNIGHT1) || (_reputationScore < 0 && pledgeType > Clan.SUBUNIT_ROYAL2)))
		{
	...
	public boolean levelUpClan(Player player)
	{
		...
		{
			case 0:// upgrade to 3
				if (player.getSp() >= 1 && player.destroyItemByItemId("ClanLvl", 6673, 1, player.getTarget(), true))
				{
					player.removeExpAndSp(0, 1);
					increaseClanLevel = true;
				}
				break;
			
			case 1:// upgrade to 3
				if (player.getSp() >= 1 && player.destroyItemByItemId("ClanLvl", 6673,3, player.getTarget(), true))
				{
					player.removeExpAndSp(0, 1);
					increaseClanLevel = true;
				}
			...
			case 2:// upgrade to 3
				if (player.getSp() >= 1 && player.destroyItemByItemId("ClanLvl", 6673, 5, player.getTarget(), true))
				{
					player.removeExpAndSp(0, 1);
					increaseClanLevel = true;
				}
			...
			case 3:// upgrade to 3
				if (player.getSp() >= 1 && player.destroyItemByItemId("ClanLvl", 6673, 7, player.getTarget(), true))
				{
					player.removeExpAndSp(0, 1);
					increaseClanLevel = true;
				}
			...
			case 4:// upgrade to 3
				if (player.getSp() >= 1 && player.destroyItemByItemId("ClanLvl", 6673, 9, player.getTarget(), true))
				{
					player.removeExpAndSp(0, 1);
					increaseClanLevel = true;
				}
			...
			case 5:// upgrade to 3
				if (player.getSp() >= 1 && player.destroyItemByItemId("ClanLvl", 6673, 11, player.getTarget(), true))
				{
					player.removeExpAndSp(0, 1);
					increaseClanLevel = true;
				}
			...
			case 6:// upgrade to 3
				if (player.getSp() >= 1 && player.destroyItemByItemId("ClanLvl", 6673, 13, player.getTarget(), true))
				{
					player.removeExpAndSp(0, 1);
					increaseClanLevel = true;
				}
			...
			case 7:// upgrade to 3
				if (player.getSp() >= 1 && player.destroyItemByItemId("ClanLvl", 6673, 15, player.getTarget(), true))
				{
					player.removeExpAndSp(0, 1);
					increaseClanLevel = true;
				}
