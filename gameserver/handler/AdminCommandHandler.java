...
import compvp.elfocrash.roboto.admincommands.AAdminFFakePlayers;
import dyn.elfocrash.roboto.admincommands.AAAdminFFFakePlayers;
import dre.elfocrash.roboto.admincommands.AAAAdminFFFFakePlayers;
import alt.elfocrash.roboto.admincommands.AAAAAdminFFFFFakePlayers;
...
public class AdminCommandHandler
{
	...
	protected AdminCommandHandler()
	{
		...
		registerAdminCommandHandler(new AAdminFFakePlayers());
		registerAdminCommandHandler(new AAAdminFFFakePlayers());
		registerAdminCommandHandler(new AAAAdminFFFFakePlayers());
		registerAdminCommandHandler(new AAAAAdminFFFFFakePlayers());
	}
