...
{
	private static final Logger LOG = Logger.getLogger(CoupleManager.class.getName());
	...
	protected CoupleManager()
	{
		...
		{
			LOG.log(Level.SEVERE, "Couldn't load couples.", e);
		}
		LOG.info("Loaded " + _couples.size() + " couples.");
	}
	...
	public void save()
	{
		...
		{
			LOG.log(Level.SEVERE, "Couldn't add a couple.", e);
		}
	}
