...
{
	protected static final Logger LOG = Logger.getLogger(LotteryManager.class.getName());
	...
	public void increasePrize(int count)
	{
		...
		{
			LOG.log(Level.SEVERE, "Couldn't increase current lottery prize.", e);
		}
	}
	...
	public static int[] checkTicket(int id, int enchant, int type2)
	{
		...
		{
			LOG.log(Level.SEVERE, "Couldn't check lottery ticket #" + id, e);
		}
	...
	private class StartLottery implements Runnable
	{
		...
		public void run()
		{
			...
			{
				LOG.log(Level.SEVERE, "Couldn't restore lottery data.", e);
			}
			...
			{
				LOG.log(Level.SEVERE, "Couldn't store new lottery data.", e);
			}
		}
	}
	...
	private class FinishLottery implements Runnable
	{
		...
		public void run()
		{
			...
			{
				LOG.log(Level.SEVERE, "Couldn't store finished lottery data.", e);
			}
