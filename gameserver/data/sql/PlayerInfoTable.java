...
{
	private static final Logger LOG = Logger.getLogger(PlayerInfoTable.class.getName());
	...
	protected PlayerInfoTable()
	{
		...
		{
			LOG.log(Level.SEVERE, "Can't load player infos.", e);
		}
		
		LOG.info("Loaded " + _infos.size() + " player infos.");
	}
