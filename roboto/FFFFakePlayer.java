...
public class FFFFakePlayer extends Player
{
   ...
   private static final FFFFakePMResponder _pmResponder = new FFFFakePMResponder();	
	...
	private long _lastMoveTimestamp = System.currentTimeMillis();
	...
	/**
	 * Ενημερώνει πότε έγινε η τελευταία μετακίνηση
	 */
	public void updateLastMoveTimestamp() {
	    _lastMoveTimestamp = System.currentTimeMillis();
	}
	
	/**
	 * Επιστρέφει timestamp τελευταίας μετακίνησης
	 */
	...
	public boolean doDie(Creature killer) {
	    if (!super.doDie(killer))
	        return false;
	    FFFFakePlayerManager.INSTANCE.teleportDeadBot(this);
