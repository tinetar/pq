...
public class SSSSaggitariusAI extends CCCCombatAI implements IIIIConsumableSpender {
    ...
    public void thinkAndAct() {
        ...
        // Ανίχνευση συμμάχων που δέχονται επίθεση
        ...
        // Ανίχνευση παικτών που επιτίθενται στο bot
    ...
    protected List<OOOOffensiveSpell> getOffensiveSpells() {
        ...
        spells.add(new OOOOffensiveSpell(1206, 15)); // Double Shot
        spells.add(new OOOOffensiveSpell(1207, 10)); // Triple Shot
        spells.add(new OOOOffensiveSpell(1208, 8));  // Rapid Fire
        return spells;
    }
    ...
    protected List<SSSSupportSpell> getSelfSupportSpells() {
        ...
        selfBuffs.add(new SSSSupportSpell(12015, 1));
        selfBuffs.add(new SSSSupportSpell(99, 1));
        return selfBuffs;
    }
}
