 ...
 *
 */
public class AAAArchmageAI extends CCCCombatAI
{
	public AAAArchmageAI(FFFFakePlayer character)
	{
		super(character);		
	}
	...
	protected List<OOOOffensiveSpell> getOffensiveSpells()
	{
		...
		_offensiveSpells.add(new OOOOffensiveSpell(1230, 1));
		_offensiveSpells.add(new OOOOffensiveSpell(1339, 1));	
